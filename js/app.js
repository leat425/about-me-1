...
// 0. Number Question: add a question that requires a number input
...
var userGuess = parseInt(prompt('number 1-10'));
    console.log('user input: ' + userGuess);

for(var x = 0; x < randArr.length; x++){
    console.log('x referencing: ', userGuess[x]);
